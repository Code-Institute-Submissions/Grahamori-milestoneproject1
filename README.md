...
Had some deployment issues while trying to submit a Netlify link on project submission form, so alternatively I have set up GitHub pages on my Project as well as also still being live via Netlify as originally intended. Have discussed thsi issue with jim_community_ci via slack and he is aware of the issue and passed it along.
